...
2. Create your task branch: `git checkout -b trainee/<your-name>/task-06`
...
7. Push branch: `git push origin trainee/<your-name>/task-06`

## Expected Deliverable
- Branch exists: `trainee/<your-name>/task-06`
...
## Submission (GitHub)
- Source branch: `trainee/<your-name>/task-06`
